...
function login(){
	...
	if(bool) {
		...
		$.ajax({
			...
			url: "/online/LoginStudentServlet",
			success: function(data) {
  				if(data.success){
  					if(data.successExam){
  						window.location.href="/online/demo.jsp";
  					}else{
  						window.location.href="/online/exam.jsp";
  					}
...
function _hyz(){
	     ...
	     img.src="/online/VerifyCodeServlet?a="+new Date().getTime();
	  } 
